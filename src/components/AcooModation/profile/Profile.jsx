        ...
        <div className="row gx-5 ">
          ...
          >
            <div className="card-body text-center">
              ...
              <h5 className="card-subtitle my-1 text-muted ">{currentUser.guest_name}</h5>
        ...
        <div className="row gx-5 mt-5  justify-content-sm-between">
          <div className="col-md-4    card " style={{ borderRadius: "30px" }}>
            <div className="card-body ">
              <h5>{currentUser.guest_name} confirmed information</h5>
              <p className="card-text">Email address: {currentUser.email}</p>
